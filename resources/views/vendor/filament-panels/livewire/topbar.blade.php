<div class="fi-topbar-ctn">
    @php
        ...
        # AGREGAMOS $isAdminPanel Y $navigation PARA QUE NO SE MUESTRE LA NAVEGACIÓN ORIGINAL DE FILAMENT
    ...
    <nav class="fi-topbar">
        ...
        {{-- APP LAUNCHER (EL DROPDOWN DE APPS) --}}
        @if ($hasNavigation)
            <x-app-launcher :navigation="$navigation" />
        @endif
        ...
        {{-- TOP-BAR DINÁMICO (HORIZONTAL) --}}
        @if ($hasNavigation)
            {{-- <x-topbar-navigation :navigation="$navigation" /> --}}
            <x-app-sub-navigation :navigation="$navigation" />
        @endif

        {{-- AGREGAMOS FALSE AL IF PARA QUE NO SE MUESTRE LA NAVEGACIÓN ORIGINAL DE FILAMENT --}}
        @if (false && ($hasTopNavigation || (! $hasNavigation)))
